...
module GeneratedPathHelpersModule
  ...
  def api_fiat_value_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_user_registration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def charts_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_transaction_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_user_setting_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def new_user_setting_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def user_setting_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def user_settings_path(*args); end
end

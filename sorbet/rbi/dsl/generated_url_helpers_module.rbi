...
module GeneratedUrlHelpersModule
  ...
  def api_fiat_value_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_user_registration_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def charts_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_transaction_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_user_setting_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def new_user_setting_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def user_setting_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def user_settings_url(*args); end
end

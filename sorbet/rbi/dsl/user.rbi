...
class User
  ...
  module GeneratedAssociationMethods
    sig { params(args: T.untyped, blk: T.untyped).returns(::UserSetting) }
    def build_user_setting(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::UserSetting) }
    def create_user_setting(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::UserSetting) }
    def create_user_setting!(*args, &blk); end

    sig { returns(T.nilable(::UserSetting)) }
    def reload_user_setting; end

    sig { void }
    def reset_user_setting; end
    ...
    sig { returns(T.nilable(::UserSetting)) }
    def user_setting; end

    sig { params(value: T.nilable(::UserSetting)).void }
    def user_setting=(value); end
  end
